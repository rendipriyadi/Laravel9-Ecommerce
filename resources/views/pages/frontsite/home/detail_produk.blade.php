            ...
            <div class="row s_product_inner">
                <div class="col-lg-6">
                    <div class="s_Product_carousel">
                        <div class="single-prd-item">
                            <img class="img-fluid"
                                src="{{ request()->getSchemeAndHttpHost() . '/storage' . '/' . $product->photo }}"
                                alt="">
                        </div>
                        <div class="single-prd-item">
                            <img class="img-fluid"
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="s_product_text">
                        <h3>{{ isset($product->name) ? $product->name : '' }}</h3>
                        <h2>{{ 'IDR ' . number_format($product->price) ?? '' }}</h2>
                        <ul class="list">
                            <li><a class="active" href="#"><span>Category</span> :
                                    {{ isset($product->category->name) ? $product->category->name : '' }}</a></li>
                        ...
                        <div class="product_count">
                            ...
                            <input type="text" name="qty" id="sst" maxlength="100" value="1"
